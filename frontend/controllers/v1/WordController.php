    ...
    public function actionDemo(){
        ...
        if($user['emp_street2'] ==''){
         ...
         if($user['emp_mobile'] ==''){
             ...
             $telephone = $user['emp_mobile'];
         }

        if($user['emp_work_email'] ==''){
            $email = '';
        }else{
            $email = $user['emp_work_email'];
        }
        ...
        if(!empty($work)){
            ...
            foreach ($work as $k => $v){
                $num = $k+1;
                $work_str.=$num.'、'.$v['time_in'].'-'.$v['time_out'].'   '.$v['tmpclassname'].'<w:br />';
            }
        ...
        $PHPWord = new \PHPWord();
        $document = $PHPWord->loadTemplate('/data/wwwroot/uploadfile/word/templet.docx');
        ...
        $document->setValue('address', iconv('utf-8', 'GB2312//IGNORE', $address));
        $document->setValue('telephone', iconv('utf-8', 'GB2312//IGNORE', $telephone));
        $document->setValue('email', iconv('utf-8', 'GB2312//IGNORE', $email));
