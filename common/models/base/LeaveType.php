...
abstract class LeaveType extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(\common\models\Leave::className(), ['leave_type_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\common\models\LeaveEntitlement::className(), ['leave_type_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\common\models\LeaveRequest::className(), ['leave_type_id' => 'id']);
    }
