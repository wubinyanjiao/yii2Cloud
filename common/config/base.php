...
$config = [
    ...
    'components' => [
        ...
        'orangehrm'=>[
                ...
                'dsn' => env('ORANGE_DB_DSN'),
                'username' => env('ORANGE_DB_USERNAME'),
                'password' => env('ORANGE_DB_PASSWORD'),
    ...
    'params' => [
        ...
        'SELECT_EMPLOYEE_BY_DIRECTOR'=>[1,4],
        'SELECT_EMPLOYEE_BY_DEPUTYDIRECTOR'=>[1,4,5],
        'XAJDYFYYXB'=>'xajdyfyyxb',
        'WEIXINBINDLABEL'=>'https://dev.api.weixin.ebangong365.com/api/web/index.php?r=v1/valid/bindLabel',   
        //'WEIXINBINDLABEL'=>'https://api.ebangong365.com/api/web/index.php?r=v1/valid/ubindLabel';
        'WEIXINUBINDLABEL'=>'https://dev.api.weixin.ebangong365.com/api/web/index.php?r=v1/valid/ubindLabel',   //解绑
        'WEIXINBACKURL'=>'http://test.xajdyfyyxb.ebangong365.com/wxdev/live/#/',
    ],
